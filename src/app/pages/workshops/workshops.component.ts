        ...
        <div class="speakers__list">
          <div class="speaker speaker--start" *ngFor="let workshopElement of workshopService.getWorkshops()">
            ...
            <div class="speaker__info">
              <span class="workshop__time">
                H {{ workshopElement.start_time }} -> {{ workshopElement.end_time }}
              </span>
              <a [href]="workshopElement.targetUrl" rel="noopener" target="_blank">
                <h2 class="speaker__name">{{ workshopElement.name }}</h2>
              </a>
              <p class="speaker__desc" [innerHTML]="workshopElement.description"></p>
              <a
                class="speaker__twitter"
                *ngFor="let twitter of workshopElement.twitter"
...
export class WorkshopsComponent implements OnInit {
  constructor(public workshopService: WorkshopsService, private seoService: SeoService) {}
  ...
  ngOnInit() {
    this.seoService.generateTags({
      ...
      description:
        "We're hosting two full-day workshops to for even more in-depth learning. Angular Architecture by John Papa and Dan Wahlin + ngGirls Workshop",
    });
  }
}
