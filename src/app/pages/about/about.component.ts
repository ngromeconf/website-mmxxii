        ...
        <div class="site-content__intro">
          ...
          <div class="site-content__intro__info__inner">
            <p>
              ...
              of volunteers. We are all active members of the tech community,
              and run or contribute to various free local meetups, workshops,
              and education initiatives.
            </p>
            <p>
              NG-Rome event is the biggest <b>International</b> Angular
              Conference in Italy, helping bring together ideas and developers
              from all the <b>corners of Italy</b> and Europe.
            </p>
            <p>
              The community is born by a group of passionate devs, JavaScript
              lovers, and enthusiastic developer that use the
              <b>Angular</b> framework.
            </p>
            <p>
            ...
            <div class="content__intro__info__inner__yolo">
              <blockquote class="twitter-tweet" data-lang="en">
                <p lang="en" dir="ltr">
                  ...
                  >
                  🇮🇹
                  <a href="https://t.co/9gaoN3AJer"
                    >pic.twitter.com/9gaoN3AJer</a
                  >
                </p>
